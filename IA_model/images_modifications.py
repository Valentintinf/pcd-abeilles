...
class image_modification():
    def __init__(self, images):
        self.images = np.asanyarray([np.asarray(image) for image in images], dtype="object")
    ...
    def get_by_index(self, indeces):
        ...
        return image_modification(self.images[indeces])
    ...
    def _clone(self):
        clone = image_modification(self.images.copy())
